...
Orient product users, stakeholders, and design-minded readers.

## Composition Prompt

```text
Write the UX Wiki page for the UX human wiki.
Orient product users, stakeholders, and design-minded readers.
...
The UX wiki explains Wikiwiki from the point of view of the people who benefit from the product, not the people implementing it.

Wikiwiki helps a project keep its context alive. Instead of asking a human to remember every decision, convention, and workflow, coding agents capture structured records as they work. Those records are then rendered or compiled into readable documentation.

For product readers, the important idea is simple: Wikiwiki makes project knowledge feel current. It gives teams a way to trust that the docs are connected to recent work, explicit decisions, and visible provenance.

Start with [Product Overview](./product-overview.md) for the basic product story, [User Experience](./user-experience.md) for the working loop, and [UX Decisions](./decisions.md) for the choices that shape the experience.
