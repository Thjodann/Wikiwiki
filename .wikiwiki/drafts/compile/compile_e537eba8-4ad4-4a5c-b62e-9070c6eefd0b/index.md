...
Choose a role-oriented wiki: UX or DX.

## Composition Prompt

```text
Write the Human Wiki page for the ux and dx human wiki.
Choose a role-oriented wiki: UX or DX.
...
Wikiwiki now publishes two human-readable views over the same repo memory.

- [UX Wiki](./ux/index.md): for people trying to understand the product experience, user value, and product decisions.
- [DX Wiki](./dx/index.md): for developers, maintainers, and coding agents who need implementation context.

Both wikis come from the same structured records under `.wikiwiki/records/`. That shared source of truth is the point: agents maintain compact, auditable knowledge while they work, and `wk compile` turns that knowledge into pages humans can actually read.

Use the UX wiki when the question is "what is this product and why does it matter?" Use the DX wiki when the question is "how does this repo work and how should I change it safely?"
